...
import GrizouConsultant from '@/components/grizou-contest/grizou-consultant';
import GrizouOffer from '@/components/grizou-contest/grizou-offer';
...
/**
 * The page for the Grizou contest
 * @return {JSX.Element} The page for the Grizou contest
 */
export default function GrizouContest(): JSX.Element {
	return (
		<>
